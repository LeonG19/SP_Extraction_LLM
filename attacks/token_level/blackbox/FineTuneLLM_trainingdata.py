...
Holly Black is a best-selling author of contemporary fantasy novels for kids, teens,
...
Ted Naifeh) The Poison Eaters and Other Stories, a collection of short fiction, and The Curse
...
middle grade novel, Doll Bones, and the dark fantasy stand-alone
"""
...
if __name__ == "__main__":
    ...
    tokenizer = AutoTokenizer.from_pretrained(
        script_args.tokenizer_name, padding_side = "left",trust_remote_code=True
    )
    ...
    train_dataset = Dataset.from_dict(
        {
            ...
            "questions": [f"{tokenizer.bos_token}" * 30] * training_num,
        }
    )
